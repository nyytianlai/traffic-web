 ...
 * @Date: 2022-11-11 12:15:24
 * @LastEditTime: 2022-12-06 14:34:52
 * @FilePath: \traffic-web\src\views\trafficSafety\safetyMonitoring\components\base-trend-chart.vue
...
<script setup>
  ...
  const option = computed(() => {
    ...
    const data2 = data.sort((a, b) => moment(new Date(a.sjwd)).isAfter(moment(new Date(b.sjwd))) ? 1 : -1)
