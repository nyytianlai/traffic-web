 ...
 * @LastEditTime: 2022-12-07 15:30:42
 * @FilePath: \traffic-web\src\views\city-transit\regularTransit\components\pop-car-speed.vue
    ...
    return {
      tooltip: {
        ...
        formatter (p) {
          ...
          let str = ''
          param.forEach(item => {
            const isQS = item.seriesName === '实时'
            str += `
            <div class="tip-data">
              <span class="${isQS ? 'betweenName' : ''}">${item.seriesName}</span>
